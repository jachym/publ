...
\pgfdeclareimage[height=1.cm]{conference-logo}{images/logo.png}
...
\note<2>{a jsem předseda českého sdružení Otevřená geoinfrastruktura.
...
\begin{frame}\begin{center}
\includegraphics[width=0.75\textwidth]<1>{images/grass.jpg}
...
\note<3>{A dnes chápu, že open source, nebo
...
%%\begin{frame}
%%\begin{center}
%%\includegraphics[width=0.5\textwidth]<3>{images/connected_people.jpeg}
%%\begin{center}\note<1>{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics<1>[width=0.8\textwidth]{images/qgis.jpg}
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.7\textwidth]{images/server.jpg}
%%\note<1>{Nyní několik zástupů serverových programů. Tady těch obrázků bude
...
%%\includegraphics[width=0.4\textwidth]{images/osgeo-projects.png}
%%\note{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.7\textwidth]{images/missing.jpg}
%%\note{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.5\textwidth]{images/sparta.jpg}
%%\note{
%%Může se stát, že na váš úkol neexistuje Open Source odpověď. V tom případě máte
%%dvě možnosti: zvažte, jestli je ve vašich silách jakkoliv přispět do
%%existujícího projektu nebo vytvořit nový - je to tak snadné. Nebo jděte do
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.5\textwidth]{images/confused.jpg}
...
%%\includegraphics<2>[width=0.5\textwidth]{images/ponorka.png}
%%\note{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.5\textwidth]{images/empty-chair.jpg}
%%\note{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics<1->[width=0.4\textwidth]{images/data-open.jpg}
%%\includegraphics<2->[width=0.4\textwidth]{images/mapping-software.jpg}\\
%%\includegraphics<3->[width=0.4\textwidth]{images/SettingStandard.png}
%%    \note{
...
%%
%%\begin{frame}\begin{center}
%%\includegraphics[width=0.4\textwidth]{images/dobias.jpg}
%%\includegraphics[width=0.4\textwidth]{images/mitasova.jpg}\\
%%Martin Dobiáš (QGIS) \hfill Helena Mitášová (GRASS)\\
%%\includegraphics[width=0.4\textwidth]{images/hofierka.jpg}
%%\includegraphics[width=0.4\textwidth]{images/ivan.png}\\
