...
\includegraphics[width=0.6\textwidth]<6>{images/linux-milestones.png}
...
\begin{itemize}
    ...
    \item<4->právo sdílet zdrojový kód a 
    \item<5->právo měnit zdrojový kód a dále ho sdílet.
\end{itemize}
}
...
software, místo aby se učily obecné principy GIS? \\
~\\
Moc se mi líbila prezentace pana Kubíčka o profesním  vzdělávání v
geoinformatice a dává mi určitou naději.}
\end{center}\end{frame}
...
\begin{frame}\begin{center}
\includegraphics[width=0.6\textwidth]{images/stamp.jpg}
...
\includegraphics[width=0.7\textwidth]<2>{images/mentors-team.png}
\note<1>{
...
%\includegraphics[width=0.6\textwidth]<2>{images/mentors-team-2.jpg}
\note<1>{Pardon, špatná fotka}
\note<2>{
...
\begin{frame}\begin{center}
    ...
    \href{mailto:info@gismentors.eu}{info@gismentors.eu} $|$
    \url{http://gismentors.eu}\\
    \url{http://github.com/gismentors}
