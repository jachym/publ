...
renderers<-read.table('results/result-points-paning.txt', header=T)
...
renderers<-read.table('results/result-lines-paning.txt', header=T)
...
png('graphs/result-polygons-rendering.png', width=800, height=480)
...
renderers<-read.table('results/result-polygon-paning.txt', header=T)
png('graphs/result-points-panning', width=800, height=480)
